...
public class StringUtil {
    ...
    private static DateTimeFormatter DateTimeFormating = DateTimeFormatter.ofPattern("dd/MM/yyyy hh:MM:SS");;
    ...
    public static SimpleDateFormat dateFormater(){
        return StringUtil.DateFormating;
    }
    public static DateTimeFormatter dateTimeFormater(){
        return StringUtil.DateTimeFormating;
    }
